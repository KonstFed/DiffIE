...
class BaseTrainer(ABC):
    ...
    def _setup_optimizer(self, learning_rate: float, weight_decay: float):
        ...
        if trainable_params:
            ...
            raise ValueError("No trainable parameters found. Ensure models are initialized before calling _setup_optimizer.")
    ...
    def train(
        ...
        total_params = sum(p.numel() for model in self.get_trainable_models() for p in model.parameters())
